    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->email  == $user->email) {
            ...
            if (count($checkEmailExist) > 0){
                return redirect()->route('customer.profile')->with('error' , __('customers-profile.email_exist'));
            }
        }
        ...
        // }
        return redirect()->route('customer.profile')->with('message' ,  __('admin-customers.customer_profile_update'));
    }
