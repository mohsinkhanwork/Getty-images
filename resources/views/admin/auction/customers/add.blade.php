            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"> {{ isset($user) ?  __('admin-customers.edit_customer_title') : 'Kunde erstellen' }} </h3>
                    </div>
                    <form method="post"
                          action="{{ isset($user) ? route('admin.customer.update', $user->id) : route('admin.customer.create')}}">
                        @csrf
                        <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        @if(isset($user))
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input  class="form-control-plaintext" value="{{$user->id}}">
                                                </div>
                                            </div>
                                        @endif
                                        <div class="form-group row">
                                            <label for="name" class="col-sm-3 col-form-label">Anrede <strong class="text-danger">*</strong></label>
                                            <div class="col-sm-8">
                                                <select name="title" id="title" class="form-control @error('title') is-invalid @enderror">
                                                    <option value="">--</option>
                                                    <option {{ isset($user) ?  ($user->title == 'mr'  ? 'selected' : '') : (old('title') == 'mr'  ? 'selected' : '')}} value="mr">{{__('auth.customer_registration_form_input_title_mr')}}</option>
                                                    <option {{ isset($user) ? ($user->title == 'mrs' ? 'selected' : '') : (old('title') == 'mrs'  ? 'selected' : '') }}  value="mrs">{{__('auth.customer_registration_form_input_title_mrs')}}</option>
                                                </select>
                                                @error('title')
                                        ...
                                        <div class="form-group row">
                                            <label for="first_name" class="col-sm-3 col-form-label">Vorname <strong class="text-danger">*</strong></label>
                                            <div class="col-sm-8">
                                                <input autofocus type="text" value="{{  isset($user) ?   $user->first_name : old('first_name') }}"
                                                       name="first_name"
                                        ...
                                        <div class="form-group row">
                                            <label for="name" class="col-sm-3 col-form-label">Nachname <strong class="text-danger">*</strong></label>
                                            <div class="col-sm-8">
                                                <input autofocus type="text" value="{{  isset($user) ?  $user->last_name : old('last_name')}}"
                                                       name="last_name"
                                        ...
                                        <div class="form-group row">
                                            <label for="name" class="col-sm-3 col-form-label">Sprache <strong class="text-danger">*</strong></label>
                                            <div class="col-sm-8">
                                                <select name="lang" id="lang" class="form-control @error('lang') is-invalid @enderror">
                                                    <option value="">--</option>
                                                    <option {{  isset($user) ?   ($user->lang == 'en'  ? 'selected' : '' ) : (old('lang') == 'en'  ? 'selected' : '')}} value="en">Englisch</option>
                                                    <option {{  isset($user) ?   ($user->lang == 'de' ? 'selected' : '') : (old('lang') == 'de'  ? 'selected' : '') }}  value="de">Deutsch</option>
                                                </select>
                                                @error('lang')
                                                <span class="invalid-feedback error" role="alert">
                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input autofocus type="email" value="{{  isset($user) ?   $user->email : old('email') }}"
                                                       name="email"
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary btn-sm float-right"> {{ isset($user) ? __('admin-customers.edit_customer_title') : 'Kunde erstellen'}}  </button>
