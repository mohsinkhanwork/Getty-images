                ...
                <div class="card">
                    ...
                    <div class="card-body"> 
                        @if(!($data['user']->customer_login_security && $data['user']->customer_login_security->google2fa_enable))
                            <p>Die Zwei-Faktor-Authentifizierung (2FA) erhöht die Zugriffssicherheit, da nicht nur Ihre
                                E-Mailadresse und Ihr Passwort sondern auch noch zusätzlich ein 6 stelliges 2FA
                                Einmal-Passwort für Ihre Identität bei der Anmeldung überprüft wird. Diese zusätzliche
                                Überprüfung Ihrer Anmeldedaten schützt Sie besser vor „Password Pishing“ und „Brute
                                Force“ Passwort Angriffen, die gestohlene Anmeldeinformationen verwenden oder ein zu
                                schwaches Passwort ausnutzen. Dieses 2FA Einmal-Passwort wird von der kostenlosen
                                Handy-APP „Google Authenticator“ alle 30 Sekunden neu erstellt und ist immer nur 30
                                Sekunden gültig. </p>
                        @endif
                        @if (session('error'))
