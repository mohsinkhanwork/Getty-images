    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <form method="post"
                      action="{{ route('admin.customer.update', session()->get('customer.id')) }}">
                    @csrf
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="title" id="title" class="form-control @error('title') is-invalid @enderror">
                                                <option value="">--</option>
                                                <option {{ session()->get('customer.title') == 'mr' ? 'selected' : '' }}  value="mr">{{__('auth.customer_registration_form_input_title_mr')}}</option>
                                                <option {{ session()->get('customer.title') == 'mrs' ? 'selected' : '' }}  value="mrs">{{__('auth.customer_registration_form_input_title_mrs')}}</option>
                                            </select>
                                            @error('title')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input autofocus type="text" value="{{ session()->get('customer.first_name') }}"
                                                   name="first_name"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input autofocus type="text" value="{{ session()->get('customer.last_name') }}"
                                                   name="last_name"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="lang" id="lang" class="form-control @error('lang') is-invalid @enderror">
                                                <option value="">--</option>
                                                <option {{ session()->get('customer.lang') == 'en' ? 'selected' : '' }} value="en">Englisch</option>
                                                <option {{ session()->get('customer.lang') == 'de' ? 'selected' : '' }} value="de">Deutsch</option>
                                            </select>
                                            @error('lang')
                                            <span class="invalid-feedback error" role="alert">
                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input autofocus type="email" value="{{ session()->get('customer.email') }}"
                                                   name="email"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input autofocus type="password" name="password"
                                                   class="form-control @error('password') is-invalid @enderror" value="{{ session()->get('customer.password') }}">
