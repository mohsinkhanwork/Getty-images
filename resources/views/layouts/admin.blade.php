        ...
        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item @if($sidebar == 'Benutzer' /*or $sidebar == 'Kunde'*/) menu-open @endif">
                        <a href="#" class="nav-link">
                        ...
                        <ul class="nav nav-treeview">
                             <li class="nav-item">
                                <a href="{{route('admin.home')}}" class="nav-link @if($sidebar == 'Benutzer') active @endif">
                                    <i class="nav-icon fas"></i>
                                    <p>Benutzer</p>
                                </a>
                            </li>  
                    ...
                    <li class="nav-item">
                        <a href="{{route('admin.customers')}}" class="nav-link @if($sidebar == 'Kunden') active @endif">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>
                                kunden
                            </p>
